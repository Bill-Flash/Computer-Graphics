...
public class Point4f {
	...
	public Point4f PlusVector(Vector4f Additonal) { 
	 ...
	 return new Point4f(getPostion(0)+Additonal.x, 
			 getPostion(1)+Additonal.y, 
			 getPostion(2)+Additonal.z, 
			 getPostion(3)+Additonal.a );
	} 
	...
	public Point4f MinusVector(Vector4f Minus) { 
		//this.x - Minus.x etc. can return a correct answer, following the ordered index
		 return new Point4f(getPostion(0)-Minus.x, 
				 getPostion(1)-Minus.y, 
				 getPostion(2)-Minus.z, 
				 getPostion(3)-Minus.a );
	...
	public Vector4f MinusPoint(Point4f Minus) { 
		//this.x - Minus.x etc. can return a correct answer, following the ordered index
		 return new Vector4f(getPostion(0)-Minus.x, 
				 getPostion(1)-Minus.y, 
				 getPostion(2)-Minus.z, 
				 getPostion(3)-Minus.a );
	}
