...
public class Vector4f {
	...
	{ 
		//this.x - Minus.x etc. can return a correct answer, following the ordered index
		return new Vector4f(this.x-Minus.x,
			this.y-Minus.y,
			this.z-Minus.z,
			this.a-Minus.a);
	}
	...
	{ 
		//this.x + Additonal.x etc. can return a correct answer, following the ordered index
		return new Point4f(this.x+Additonal.x,
			this.y+Additonal.y,
			this.z+Additonal.z,
			this.a+Additonal.a);
	} 
	...
	{
		//each component is multiplied by the scale
		return new Vector4f(scale*this.x,
			scale*this.y,
			scale*this.z,
			scale*this.a);
	}
	...
	{
		//this time scale is -1
		return byScalar(-1.0f);
	}
	
	//implement getting the length of a Vector  
	public float length()
	{
		   //using Euclidean norm by Math calss
